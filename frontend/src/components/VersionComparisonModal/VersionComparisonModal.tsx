...
export const VersionComparisonModal = ({
  ...
  const [leftVersion, setLeftVersion] = useState(versions[0]?.name || "");
  ...
  const leftTranslations = translations.filter(
    (t) => t.version === leftVersion && t.language === selectedLanguage,
  );
  const rightTranslations = translations.filter(
    (t) => t.version === rightVersion && t.language === selectedLanguage,
  );
          ...
          <table className={styles.table}>
            <thead className={styles.thead}>
              <tr>
                ...
                <th className={styles.th}>{leftVersion}</th>
                <th className={styles.th}>{rightVersion}</th>
              </tr>
            </thead>
